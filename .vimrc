...
" :PluginClean      - confirms removal of unused plugins; append `!` to auto-approve removal
  ...
  " Language {
  " --------------------
    " http://vimawesome.com/plugin/vim-colors-solarized
    ...
    " http://vimawesome.com/plugin/vim-angular2-snippets
...
"   export TERM=xterm-256color
  ...
  " ------------
    ...
    set timeoutlen=1000 ttimeoutlen=0 " avoid time delay from insert to normal mode after press ESC
